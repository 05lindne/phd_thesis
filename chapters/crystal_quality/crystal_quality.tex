			...
			\subsection{Crystallinity and Grain Boundaries}\label{subsec::tem_crystal}
				...
				\begin{figure}[!htb]
					\begin{subfigure}[t]{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, height = 6cm]{./pics/AM060-II-k4-2.png}}
						\caption{}
					...
					\begin{subfigure}[t]{ 0.49\linewidth}
						...
						\begin{tikzpicture}
							...
							\node{\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, height = 6cm]{./pics/AM060-II-k1-3.png}}};
