...
\section[Wet-Milling]{Wet-Milled Nanodiamonds}\label{sec::wet_milled_nds}
	...
	\begin{figure}[tp]
		...
		\begin{subfigure}[t]{ 0.49\linewidth}
			...
			\centering
			\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, height=5cm]{./pics/milling_sketch.pdf}}
			% \caption{TEM picture of a \SI{100}{\nano\meter} diamond crystal.}
		\end{subfigure}
		\caption{Pictures of the milled \nds (sample \insituH). (a) SEM picture showing the distribution of the \nd crystals on the \ir substrate (\correct{sample \insituH}). (b) Sketch showing the wet-milling process in a vibrational mill. Vibrations from the mill drive the beads which collide with the diamond material and crush it to smaller pieces.}
	...
	They were then drop-casted onto an \ir substrate and implanted with \ch{^{28}Si^1+} \todo[fancyline]{implantation parameters} \footnote{Implantation was performet by \rogalla}.
