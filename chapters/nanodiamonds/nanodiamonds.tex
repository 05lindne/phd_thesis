...
% 	\begin{figure}[htp]
% 		\centering
% 		\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.5\textwidth]{./pics/milling_sketch.pdf}}
...
% 			\begin{subfigure}[t]{ 0.49\linewidth}
% 				\centering
% 				\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/am21-sc-7-x20000-1.png}}
% 				\caption{}\label{subfig::sunken_nd}
% 			\end{subfigure}
% 			\hfill
% 			\begin{subfigure}[t]{ 0.49\linewidth}
% 				\centering
% 				\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/M5_1_4_17.png}}
...
% 			\centering
% 			\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/siq-basd-siv2-tilt45-x10000-1.png}}
% 		\end{subfigure}
