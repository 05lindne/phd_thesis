...
\section[Wet-Milling]{Wet-Milled Nanodiamonds}\label{sec::wet_milled_nds}
	...
	\subsection{Wet-Milled \CVD \Nds}\label{subsec::milled_nds}
		...
		The median diameters of the diamonds are \SIlist{50; 70; 100}{\nano\meter} as determined by laser diffraction spectroscopy. \autoref{fig::sem_milled} shows milled \nds on-top of an \ir substrate.
	...
	\subsection{Doubly Wet-Milled Implanted \Nds Implanted With \Si}\label{subsec::2_milled_nds}
		...
		After implantation, the micro-diamonds on the \si substrate were annealed for \SI{2}{\hour} at \SI{900}{\celsius} and subsequently oxidized in air for \SI{2}{\hour} at \SI{450}{\celsius}. For a detailed explanation of the effect of annealing and oxidation refer to \autoref{subsection::ann_ox}.
		...
		This process caused the diamonds to sink into the \si surface, see \autoref{subfig::sunken_nd}.
		\\
		...
		The micro-diamonds were directly spin-coated onto $20$ \ir substrates of a side length of \SI{2}{cm} which yielded densely coated samples, see \autoref{subfig::microdiamonds}.
...
\section{\Ir Substrate}\label{sec::ir_substrate}
	...
	As mentioned in \autoref{sec::cvd}, growth on a substrate is favored, if the lattice constants of substrate and diamond to be grown are similar.
