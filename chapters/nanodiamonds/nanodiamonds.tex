...
\section[Wet-Milling]{Wet-Milled Nanodiamonds}\label{sec::wet_milled_nds}
	...
	\subsection{Wet-Milled \CVD \Nds}\label{subsec::milled_nds}
		...
		\Fref{subfig::diamond_solution} shows a photo of the obtained aqueous diamond solution, \Fref{subfig::sem_overwiew_wetmilled,subfig::sem_detail_wetmilled} shows the milled \nds on-top of an \ir substrate.
