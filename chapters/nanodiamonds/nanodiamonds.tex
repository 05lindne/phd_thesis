...
\section[HPHT]{High-Pressure High-Temperature Diamond}\label{sec::hpht}
	...
	However, the advantage is, that \todo[fancyline]{HPHT advantage}
	\\
	In the scope of this thesis, \HPHT diamonds produced by Davydov et al. \cite{Davydov2014} were spectroscopically investigated.\todo[fancyline]{wie kommen da die SiVs rein?}
...
\section[CVD]{Chemical Vapor Deposition Diamond}\label{sec::cvd}
	...
	On the substrate surface, various processes occur, such as adsorption, desorption and diffusion\todo[fancyline]{absatz zu ende bringen}.
	\\
	...
	After \nd growth, the \nds can be either investigated directly on the growth substrate or they can be shaken off in an ultrasonic bath to obtain a solution which can then be coated onto other substrates\todo[fancyline]{irgendwo einfuegen, was ich diesbezgl. gemacht hab}.
	\\
...
\section[Wet-Milling]{Wet-Milled Nanodiamonds}\label{sec::wet_milled_nds}
	...
	The beads are either driven by ultrasonic waves (in the \BASD process) or by vibrations of the vibrational mill\todo[fancyline]{info about vibrational mill}.
	...
	We investigated \nds, which were produced from a \HPHT starting material, milled by a wet-milling process and finally implanted with \ch{^{28}Si^1+} \todo[fancyline]{implantation parameters} from Dr. Detlef Rogalla at Ruhr-Universität Bochum (RUBION - Zentrale Einrichtung für Ionenstrahlen und Radionuklide).
	\\
	...
	The other sample \todo[fancyline]{wirklich basd oder wet-milled? -> aus tabelle rausnehmen}(\basdes) was produced from a commercially available diamond film, produced by the company Element Six.
	This specific diamond film already contained \si impurities\todo[fancyline]{was wurde weiter damit gemacht?}.
	...
	Prior to drop casting, the substrate was cleaned in Piranha solution (50\% sulfuric acid \ch{H2So4}, 50\% hydrogen peroxide \ch{H2O2}) to enhance the surface hydrophilicity and therefore obtain a homogeneous distribution of diamonds on the surface.
...
\end{figure}
	...
	\begin{itemize}
		\item The high hydrophility of \ir \todo[fancyline]{check numbers} enhances the homogenuity of the nanodiamonds on the substrate after spin-coating or drop-casting. 
		The hydrophility is further improved by treating the substrate in a Piranha etch (\todo[fancyline]{chem. Formel einfuegen}) by removing oxide layers on the surface. 
		...
		Additionally, boron present in \si wafers as a p-dopant reduces the melting point of \ch{si2o2}\todo[fancyline]{check in labbook I, p.41}.
