...
\chaptermark{Photonic Structures}
	...
	Obtaining a \sps with a photon flux rate large enough to reliably and precisely be measured by a low photon flux detector is a key requirement for applications in metrology \cite{Vaigu2017}\todo{ich glaub, das ist bullshit}.
	...
	\subsection{Nano-manipulator} \label{subsec::nanomanipulator}
	  ...
	  mounted inside a Thermo Scientific\texttrademark{} Helios NanoLab\texttrademark{} DualBeam\texttrademark{} microscope. This device combines a \fib and an electron microscope.
		...
		In \cref{subfig::nanomanipulator_tip} two sharpened tips are shown.
