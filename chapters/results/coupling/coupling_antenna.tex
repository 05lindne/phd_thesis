	...
	\subsection{\siv in a Plasmonic Double Bowtie Antenna}
		...
		\subsubsection{\Nds Containing Ensembles of \sivs Coupled to Antennas}\label{subsubsec::antenna_multiple_sivs}
			...
			\begin{figure}[htp]
				\begin{subfigure}[t]{ 0.49\linewidth}
					\centering
					\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, height = 0.5\textwidth]{./pics/M05-13_structure3_stitch_crop_area.jpg}}
					\caption{}
				...
				\begin{subfigure}[t]{ 0.49\linewidth}
					\centering
					\testbox{\includegraphics[trim = 0 20 70 50,  clip= true, height = 0.5\textwidth]{./pics/scan_xy-32_2APD_mum_noscale.png}}
					\caption{}
			...
			\Fref{subfig::spectrum_nd_multiple} shows the spectrum stemming from one such preselected \nd.
			The \ZPL feature exhibits a \cwl of \SI[separate-uncertainty = true]{738.55\pm0.01}{nm} and a \lw of \SI[separate-uncertainty = true]{5.0\pm0.03}{nm}, corresponding well with the \ZPL of unstrained \sivs. Photon autocorrelation measurements revealed that the \nd  contains an ensemble of \sivs collectively generating coherent \fl, see \Fref{subfig::coherent_g2}.
				...
				\begin{figure}[htp]
					\begin{subfigure}[t]{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/spe_Ir27M_f200_xy04x13y88_D09_t30_highP_fit.pdf}}
						\caption{}
					...
					\begin{subfigure}[t]{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/g2_coherent.png}}
						\caption{}
			...
			\begin{figure}[htp]
				...
				\begin{subfigure}[t]{ 0.49\linewidth}
					\centering
					\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/Ir27M_mitte_213_151111_18_edited.jpg}}
					\caption{}
					\label{subfig::pp_approach_payload}
				\end{subfigure}
				\begin{subfigure}[t]{ 0.49\linewidth}
					\centering
					\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/pick_colored.png}}
					\caption{}
				...
				\begin{subfigure}[t]{ 0.49\linewidth}
					\centering
					\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/Ir27M_mitte_213_151111_26_colored.png}}
					\caption{}
				...
				\begin{subfigure}[t]{ 0.49\linewidth}
					\centering
					\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/place_colored.png}}
					\caption{}
			...
			\begin{figure}[htp]
				\begin{subfigure}[t]{ 0.49\linewidth}
					\centering
					\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/xy_scan-11_2APD.png}}
					\caption{}
				...
				\begin{subfigure}[t]{ 0.49\linewidth}
					\centering
					\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/xy_scan-13_2APD.png}}
					\caption{}
			...
			\begin{figure}[htp]
				\begin{subfigure}[t]{ 0.49\linewidth}
					\centering
					\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/find_middle_with_ccd_highP_2_arrows.pdf}}
					\caption{}
				...
				\begin{subfigure}[t]{ 0.49\linewidth}
					\centering
					\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/antenna_convolution.png}}
					\caption{}
			...
			Finally, keeping experimental conditions unchanged, we measure a spectrum of an identical antenna without a \nd present in order to rule out surprising artifacts induced by the antenna itself. The resulting spectrum is given in \Fref{fig::spectrum_antenna_no_nd}.
				...
				\begin{figure}[htp]
					\centering
					\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.5\textwidth]{./pics/antenna_no_ND.pdf}}
		...
		\subsubsection{\Nds Containing Few \sivs Coupled to Antennas} \label{subsubsec::antenna_single_siv}
				...
				\begin{figure}[htp]
					\begin{subfigure}[t]{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/g2_sat113_5mW_corr_fit.pdf}}
						\caption{}
					...
					\begin{subfigure}[t]{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/sat114_fit_bkg.pdf}}
						\caption{}
				...
				\begin{figure}[htp]
					\begin{subfigure}[t]{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/spectrum03.pdf}}
						\caption{}
					...
					\begin{subfigure}[t]{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/single_spectrum_sat113_fit.pdf}}
						\caption{}
				...
				\begin{figure}[tp]
					...
					\begin{subfigure}[t]{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/spectrum_sat113_fit_origin.pdf}}
						\caption{}
				...
				\begin{figure}[htbp]
					\begin{subfigure}[t]{ 0.69\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = \textwidth]{./pics/dipole+damaged_antenna.png}}
						\caption{}
					...
					\begin{subfigure}[t]{ 0.29\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = \textwidth]{./pics/dipole_antenna_sketch.pdf}}
						\caption{}
