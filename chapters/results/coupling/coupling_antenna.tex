	...
	\subsection{\siv in a Plasmonic Double Bowtie Antenna}
		...
		\subsubsection{\Nds Containing Ensembles of \sivs Coupled to Antennas}\label{subsubsec::antenna_multiple_sivs}
			...
			The \ZPL feature exhibits a \cwl of \SI[separate-uncertainty = true]{738.55\pm0.01}{nm} and a \lw of \SI[separate-uncertainty = true]{5.0\pm0.03}{nm}, corresponding well with the \ZPL of unstrained \sivs. Photon autocorrelation measurements revealed that the \nd  contains an ensemble of \sivs collectively generating coherent \fl, see \Fref{subfig::coherent_g2}.
				...
				\begin{figure}[!htb]
					\begin{subfigure}{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = \pairplotwide]{./pics/spe_Ir27M_f200_xy04x13y88_D09_t30_highP_fit.pdf}}
						\caption{}
			...
			Finally, keeping experimental conditions unchanged, we measure a spectrum of an identical antenna without a \nd present in order to rule out surprising artifacts induced by the antenna itself. The resulting spectrum is given in \Fref{fig::spectrum_antenna_no_nd}.
				...
				\begin{figure}[!htb]
					\centering
					\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.6\linewidth]{./pics/antenna_no_ND.pdf}}
		...
		\subsubsection{\Nds Containing Few \sivs Coupled to Antennas} \label{subsubsec::antenna_single_siv}
				...
				\begin{figure}[!htb]
					\begin{subfigure}{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = \pairplotwide]{./pics/g2_sat113_5mW_corr_fit.pdf}}
						\caption{}
					...
					\begin{subfigure}{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = \pairplotwide]{./pics/sat114_fit_bkg.pdf}}
						\caption{}
				...
				\begin{figure}[!htb]
					\begin{subfigure}{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = \pairplotwide]{./pics/spectrum03.pdf}}
						\caption{}
					...
					\begin{subfigure}{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = \pairplotwide]{./pics/single_spectrum_sat113_fit.pdf}}
						\caption{}
				...
				\begin{figure}[!htb]
					\begin{subfigure}{ 0.49\linewidth}
						\centering
						\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = \pairplotwide]{./pics/spectrum05.pdf}}
						\caption{}
