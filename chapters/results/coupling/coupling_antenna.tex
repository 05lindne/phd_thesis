...
\section[Coupling \Nds to Optical Antennas]{Coupling \Nds to Double Bowtie Antenna Structures} \label{sec::coupling_antennas}
	...
	\subsection{\siv in a Plasmonic Double Bowtie Antenna}
		...
		\subsubsection{\Nds Containing Ensembles of \sivs Coupled to Antennas}\label{subsubsec::antenna_multiple_sivs}
			...
			After spin-coating, the sample was placed in an oven for \SI{3}{\hour} at \SI{450}{\celsius} to oxidize the surface and remove any residual graphite and amorphous carbon. See \Fref{ch::nanodiamonds} for more information.
			\\
			% position
			...
			\\
			We verified successful coupling of the ensemble of \sivs to the antenna by combining experimental and numerical results. In particular, we convolve the experimental PL spectrum of the \nd measured before placing it in the nano-antenna, see \Fref{subfig::spectrum_nd_multiple},  with the intensity spectrum of the nano-antenna obtained by means of simulations given in \Fref{fig::spectrum_antenna_nd_multiple}.
