...
{}			\caption{}
	...
	% additional methods
	As diamond material, we used an \ir coated \si wafer, on which CVD \nds had been grown (see \cref{sec::cvd}).
	These \nds exhibit a nominal size of \SI{200}{nm}.
	% preselection, 
	We selected a \nd which exhibited one dominant line at \SI{746.0}{nm} with a \lw of \SI{1.9}{nm}.
	% position
	The position was determined using a white light laser scan as described in \cref{subsec::position}.
	% transfer
	The transfer...
	% Spectroscopic measurements
	\\
	After a successful transfer of the pre-selected \nd onto the active area of VCSEL Bm4, the VCSEL was investigated in the confocal setup.
	To guarantee comparable measurements, at first we used the laser from the confocal setup to check if the \pp process was successful\todo{what does mean} and did not cause any damage to the \siv.
	...
	After the \pp process, this line is still there, albeit very small.
