...
{}			\caption{}
	...
	Another line at \SI{700}{nm} (denoted line B) \todo{check number} which was a minor feature in the spectrum before \pp, is the predominant line after the process. 
...
{}
	...
	\begin{figure}[tp]
		...
		\end{subfigure}
		\caption{(a) longpass filter  720 (b) longpass filter 710}
	\end{figure}

	\begin{figure}[tp]
		\begin{subfigure}[t]{ 0.49\linewidth}
			\centering
			\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = \textwidth]{./pics/field330_scanxy06_x19y15_34uW_t30_2_fit.pdf}}
			\caption{<caption>}
