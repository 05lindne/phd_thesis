...
{}			\caption{}
	...
	While the energy of the electrons is low compared to the ionization energy of the color center \todo{numbers}, we observed a reduction of \fl intensity after electron radiation \todo{put alex meyers observations in appendix}\todo{besser begruenden, was passiert}.
	\\
...
{}
	...
	\begin{figure}[tp]
		\centering
		\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.5\textwidth]{./pics/dbr_VCSEL.pdf}}
