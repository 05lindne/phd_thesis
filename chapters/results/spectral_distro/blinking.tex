%!TEX root = ../../../main.tex
	...
	% It is found that some of the observed emitters exhibit fluorescence intermittence, also called blinking (\cref{fig::blink}).
	...
	% \\
	% The time trace of the emitter is shown in \cref{fig::blink}.
	% In the overview picture (\cref{subfig::blink_long}), a few blinking dips can be seen with retention times of up to a few minutes.
	...
	% When zooming in, shorter retention times are observable (\cref{subfig::blink_short}).
	...
	% The red histogram in \cref{fig::fit_blink_distr} shows the retention times of the emitter in the bright state, whereas the blue histogram shows the retention times of the dark states (both omitting outliers with very long retention times).
	...
	% The solid blue line in \cref{fig::fit_blink_distr} is a lognormal fit of the distribution of the retention times in the dark state.
	...
	% All but one emitters in \hl exhibit blinking, where only one of the emitters in \vl exhibits blinking (\cref{fig::bimodal_distr}).
	...
	\section{Photostability} \label{subsec::photostab}
		...
		\begin{figure}[htp]
			\begin{subfigure}[tp]{ 0.49\linewidth}
				\centering
				\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = \textwidth]{./pics/g2zuSpektrum8_15_5_countrate_0_01_conv_screenshot.png}}
				\caption{}\label{subfig::blink_long}
			\end{subfigure}
			\hfill
			\begin{subfigure}[tp]{ 0.49\linewidth}
				\centering
				\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width =\textwidth]{./pics/g2zuSpektrum8_15_5_countrate_0_01_conv_detail.pdf}}
				\caption{}\label{subfig::blink_short}
			\end{subfigure}
		...
		The photon count time trace of emitter \emnarrow is shown in \cref{fig::blink}.
		...
		\begin{figure}[htp]
			\centering
			\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/retention_no_histo_xlim2_5.pdf}}
