%!TEX root = ../../../main.tex
	...
	\section{Photostability} \label{subsec::photostab}
		...
		The photon count time trace of \emnarrow is shown in \Fref{fig::blink}.
		In the overview picture (\Fref{subfig::blink_long}), a few blinking dips can be seen exhibiting time intervals of up to a few minutes.
		...
		The assumption that dislocations and impurities are responsible for blinking emitters is in agreement with our findings reported in \Fref{ch::crystal_quality}.
