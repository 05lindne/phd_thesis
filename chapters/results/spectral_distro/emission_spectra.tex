...
\subsection{\Zpl}\label{subsubsec::zpl}
	...
	\begin{figure}[tp]
		...
		\end{subfigure}
		\caption{Other representative examples for a) a narrow (denoted \emhtwo) and b) a broad (denoted \emvtwo) \ZPL. In contrast the spectra in \autoref{fig::spectra}, the emitters depicted here exhibit stronger sidebands.}
		\label{fig::spectra2}
	\end{figure}
