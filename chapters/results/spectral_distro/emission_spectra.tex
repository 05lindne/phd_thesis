...
\subsection{Zero-Phonon-Line}\label{subsec::zpl}
	...
	\Fref{subfig::emnarrow} shows a representative spectrum of a single emitter in \hl (denoted \emnarrow), exhibiting a \ZPL \lw of \SI{1.4}{nm} and a \cwl of \SI{726.5}{nm}.
	...
	\begin{figure}[!htb]
		\centering
		\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.6\linewidth]{./pics/schematic_gali.png}}
		\caption[Schematic diagram of ground and excited states of the \siv]{Schematic diagram of the ground and the bright (optically allowed) excited state of the negatively charged SiV defect in diamond. The valence band (VB) resonant states play a crucial role in the excitation. For the sake of simplicity, the spin-polarization of the single particle levels are not shown. Figure and caption reproduced from \cite{Gali2013}}
