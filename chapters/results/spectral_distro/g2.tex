...
% 	\Fref{fig::g2} shows the \gt functions of the two emitters introduced in \Fref{sec::spectra}, \emnarrow and \embroad.
% 	\\
...
%
	...
	\section{Photon correlation measurements} \label{subsec::g2}
		...
		The former emitter's spectrum is shown in \Fref{subfig::erlangen_spectrum}, and denoted \emhtwo. The latter is the same as \embroad indroduced in \Fref{sec::spectra}.
