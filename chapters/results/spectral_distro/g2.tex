...
% 	\\
% 	\cref{subfig::g2_a} shows the photon correlation function of \emnarrow at a power of \SI{15}{\micro\W}.
...
% 	\\
% 	\cref{subfig::g2_b} shows the \gt function of \embroad at an excitation power of \SI{200}{\micro\W}, which is 25\% of the saturation power of that emitter, which amounts to \SI{1}{mW}.
...
%
	...
	\section{Photon correlation measurements} \label{subsec::g2}
		...
		\cref{subfig::g2_a} shows the photon correlation function of an emitter in \hl. \todo{was soll ich als saettigungsleistung angeben, emitter starb vor messende}
