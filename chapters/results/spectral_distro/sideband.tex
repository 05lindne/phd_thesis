%!TEX root = ../../../main.tex
	...
	\subsection{Sideband} \label{subsubsec::sideband}
		...
		\begin{figure}[!htb]
			...
			\end{subfigure}
			\caption[Side band peaks of \sivs]{Representative spectra of emitters showing single (\subref{subfig::sideband_group_v}) and multiple (\subref{subfig::sideband_group_h}) side band peaks. The former belong to \vl, while the latter are members of \hl.}
