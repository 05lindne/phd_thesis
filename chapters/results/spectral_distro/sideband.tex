%!TEX root = ../../../main.tex
	...
	% 	The investigated emitters exhibit two different structures of sideband spectra: The spectra in \vl exhibit one strong sideband peak (\cref{fig::broad_peak_sb}), spectra in \hl exhibit several weaker sideband peaks.
	% 	\\
	...
	% 	In \cref{fig::sideband_fit} the distance between the \cwl of the sideband peak and the \cwl of the ZPL is plotted against the ZPL \cwl.
	...
	% 	\cref{fig::sideband_multfit} shows histograms of the distribution of the \cw and the \lw of the fitted peaks.
