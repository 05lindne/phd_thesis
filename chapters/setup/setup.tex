...
\chaptermark{Experimental Setup}
	...
	\section{Confocal Setup} \label{sec::confocal}
		...
		\begin{figure}[htb]
			\centering
			\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.5\textwidth]{./pics/confocal_setup_small.eps}}
		...
		\cref{fig::confocal_setup} illustrates the confocal setup deployed in this work.
		...
		\\
		The bright red color in the sketch in \cref{fig::confocal_setup} represents the path of the excitation laser beam.
		...
		\\
		The collected light follows the detection beam path depicted in dark red in \cref{fig::confocal_setup}.
	...
	\section[Surface Imaging]{Optical Imaging of The Sample Surface} \label{sec::methods_optical}
		...
		For this purpose, the sample is directly illuminated at a flat angle from outside the objective with white light from a halogen lamp, see the white light source in \cref{fig::confocal_setup}.
		...
		\begin{figure}[htb]
			\centering
			\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.5\textwidth]{./pics/hbt_spectrometer.eps}}
		...
		In chapter \cref{ch::coupling} we introduce applications of \sivs in \nds, for which knowing the precise positions of specific \nds is crucial.
	...
	\section{Spectrometer} \label{sec::methods_spectrometer}
		...
		\cref{fig::hbt_spectrometer} displays the detection part of the setup.
	...
	\section[HBT]{\HBT Setup}\label{sec::methods_hbt}
		...
		A sketch of the \hbt setup is shown in \cref{fig::hbt_spectrometer}.
