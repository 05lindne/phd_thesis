...
\chaptermark{Experimental Setup}
	...
	\section{Confocal Setup} \label{sec::confocal}
		...
		% 		\caption{Spectrometer and HBT interferometer.}
	...
	\section[HBT]{\HBT Setup}\label{sec::methods_hbt}
		...
		A \majorkeyword{\HBT setup} is used to establish the \keyword{intensity autocorrelation function} (\keyword{\gt function}) of an emitter \cite{janine::240, janine::241}.
