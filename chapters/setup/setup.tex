...
\chaptermark{Experimental Setup}
	...
	\section{Spectrometer} \label{sec::methods_spectrometer}
		...
		\begin{figure}[!htb]
			\centering
			\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.5\linewidth]{./pics/hbt_spectrometer.eps}}
	...
	\section{\HBT Setup}\label{sec::methods_hbt}
