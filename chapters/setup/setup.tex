...
\chaptermark{Experimental Setup}
	...
	\section{Confocal Setup} \label{sec::confocal}
		...
		In general, if high excitation setting is required we opt for a dichroic mirror, otherwise working with the glass plate at lower excitation is the default. This is advised since high intensities carry the danger of damaging \sivs to the point of bleaching and can also cause fluorescent intermittence of \sivs, \i.e.\ blinking, as an unwanted side-effect see \Fref{ch::siv}.
