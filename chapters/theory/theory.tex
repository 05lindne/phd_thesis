...
\section{Diamond as a host lattice}
  ...
  \begin{figure}[htbp]
		...
		\caption[Face-centered cubic diamond lattice]{Face-centered cubic diamond lattice. Note the tetrahedral arrangements of carbon atoms. Figure reproduced with permission from \cite{Riedrich-moller2014}.}
 ...
 %  \begin{figure}[htbp]
  ...
  \begin{figure}[thbp]
    \begin{subfigure}[t]{ 0.49\linewidth}
      \centering
      \testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/diamond_refraction.png}}
      \caption{}
      \label{subfig::diamond_refraction_bulk}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{ 0.49\linewidth}
      \centering
      \testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/nanodiamond_-small-14626.png}}
      \caption{}
...
\section{\Sivc} \label{sec::siv}
  ...
  \subsection{Luminescence properties}
   ...
   \begin{figure}[thbp]
 		\begin{subfigure}[t]{ 0.49\linewidth}
 			\centering
 			\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/siv_zpl.png}}
 			\caption{}
 		\end{subfigure}
 		\hfill
 		\begin{subfigure}[t]{ 0.49\linewidth}
 			\centering
 			\testbox{\includegraphics[trim = 0 0 0 0,  clip= true, width = 0.7\textwidth]{./pics/siv_sideband.png}}
 			\caption{}
 		\end{subfigure}
