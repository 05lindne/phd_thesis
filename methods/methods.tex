...
\chaptermark{Confocal Setup}
	...
	\section[Spectrometer]{Spectrometer}
		...
		The spectrometer is a Princeton Instruments Acton2500i \todo{?} spectrometer and features three gratings: \SI[per-mode=symbol]{600}{\lines\per\mm}, \SI[per-mode=symbol]{1200}{\lines\per\mm}, and \SI[per-mode=symbol]{1800}{\lines\per\mm} \todo{right dimension?}.
